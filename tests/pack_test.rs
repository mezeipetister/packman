...
#[test]
fn test_vector() {
  let mut meaning_of_life: Pack<Vec<i32>> =
    Pack::load_or_init(PathBuf::from("data/pack_test"), "meaning_of_life_vec")
      .unwrap();
...
#[test]
fn test_get() {
  let mut meaning_of_life: Pack<i32> =
    Pack::load_or_init(PathBuf::from("data/pack_test"), "meaning_of_life_get")
      .unwrap();
  *(meaning_of_life.as_mut()) = 42;
...
fn test_map() {
  let mut meaning_of_life: Pack<i32> =
    Pack::load_or_init(PathBuf::from("data/pack_test"), "meaning_of_life_map")
      .unwrap();
  *(meaning_of_life.as_mut()) = 42;
